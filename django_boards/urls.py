...
urlpatterns = [
    ...
    path('boards/<int:pk>/<slug:slug>/', board_views.TopicListView.as_view(), name='board_topics'),
    path('boards/<int:pk>/<slug:slug>/new/', board_views.TopicCreateView.as_view(), name='new_topic'),
    path('boards/<int:board_pk>/<slug:slug>/topics/<int:pk>/', board_views.PostListView.as_view(),
         name='topic_posts'),
    path('boards/<int:board_pk>/<slug:slug>/topics/<int:pk>/reply/', board_views.PostCreateView.as_view(),
         name='reply_topic'),
    path('boards/<int:board_pk>/<slug:slug>/topics/<int:topic_pk>/posts/<int:pk>/edit/',
